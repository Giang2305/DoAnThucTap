                ...
                <div class="card-body">
                  <form role="form" action="{{ url('/admin/login') }}" method="POST">
                    ...
                    <div class="form-check form-switch d-flex align-items-center mb-3">
                      ...
                      <label class="form-check-label mb-0 ms-3" for="rememberMe">Ghi nhớ thông tin</label>
                    </div>
                    ...
                    <p class="mt-4 text-sm text-center">
                      Chưa có tài khoản?
                      <a href="{{URL::to('/register')}}" class="text-primary text-gradient font-weight-bold">Đăng ký
                  </form>
                </div>
              </div>
            </div>
